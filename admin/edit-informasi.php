            ...
            <div class="box-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" placeholder="Keterangan" class="input-control"><?= $p->keterangan ?>
                    </textarea>
                    </div>

                    <div class="form-group">
                        <label>Gambar</label>
                        <img src="../uploads-informasi/<?= $p->gambar ?>" width="400px" class="image">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($update) {
                        echo "<script>window.location='informasi.php?Succes=Update Data Berhasil!'</script>";
                    } else {
