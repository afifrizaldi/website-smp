        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Logo</label>
                        <img src="../identitas/<?= $d->logo ?>" width="400px" class="image">
                    ...
                    <div class="form-group">
                        <label>Favicon</label>
                        <img src="../identitas/<?= $d->favicon ?>" class="image">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($_FILES['logo_baru']['name'] != '') {
                        ...
                        if (!in_array($formatfile_logo, $allowedtype_logo)) {
                            ...
                            return false;
                        } elseif ($filesize_logo > 100000000) {
                            echo '<div class="alert alert-error">Ukuran file logo tidak boleh lebih dari 100MB!</div>';
                            return false;
                        } else {
                    ...
                    if ($_FILES['favicon_baru']['name'] != '') {
                        ...
                        if (!in_array($formatfile_favicon, $allowedtype_favicon)) {
                            ...
                            return false;
                        } elseif ($filesize_favicon > 100000000) {
                            echo '<div class="alert alert-error">Ukuran file favicon tidak boleh lebih dari 100MB!</div>';
                            return false;
                        } else {
                    ...
                    if ($update) {
                        echo "<script>window.location='identitas-sekolah.php?Succes=Update Data Berhasil!'</script>";
                    } else {
