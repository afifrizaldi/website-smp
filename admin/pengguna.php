                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $p['level'] ?></td>
                                    <td>
                                        <a href="edit-pengguna.php?id=<?= $p['id'] ?>" title="Edit"><i class="fa fa-edit"></i></a> |
                                        <a href="hapus.php?idpengguna=<?= $p['id'] ?>" onclick="return confirm('Hapus Data?')" title="Hapus"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php }
                        } else { ?>
